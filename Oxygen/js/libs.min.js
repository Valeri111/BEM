! function (e) {
    ...
    s = 0, (r = function (e, i) {
        ...
        if ("window" === n.respondTo ? s = a : "slider" === n.respondTo ? s = l : "min" === n.respondTo && (s = Math.min(a, l)), n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
            ...
            null !== o ? null !== n.activeBreakpoint && o === n.activeBreakpoint && !i || (n.activeBreakpoint = o, "unslick" === n.breakpointSettings[o] ? n.unslick(o) : (n.options = d.extend({}, n.originalSettings, n.breakpointSettings[o]), !0 === e && (n.currentSlide = n.options.initialSlide), n.refresh(e)), r = o) : null !== n.activeBreakpoint && (n.activeBreakpoint = null, n.options = n.originalSettings, !0 === e && (n.currentSlide = n.options.initialSlide), n.refresh(e), r = o), e || !1 === r || n.$slider.trigger("breakpoint", [n, r])
        }
        ...
        for (var e = o.currentSlide, i = e + o.options.slidesToShow; e < i; e++) o.options.focusOnChange ? o.$slides.eq(e).attr({
            tabindex: "0"
        ...
        if (!0 === n.options.centerMode ? t = !0 === n.options.infinite ? (i = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (i = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (i = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, t = Math.ceil(i + n.options.slidesToShow), !0 === n.options.fade && (0 < i && i--, t <= n.slideCount && t++)), e = n.$slider.find(".slick-slide").slice(i, t), "anticipated" === n.options.lazyLoad)
            for (var s = i - 1, r = t, l = n.$slider.find(".slick-slide"), a = 0; a < n.options.slidesToScroll; a++) s < 0 && (s = n.slideCount - 1), e = (e = e.add(l.eq(s))).add(l.eq(r)), s--, r++;
        ...
        var e, i, t = this,
            ...
            n = t.length;
        for (e = 0; e < n; e++)
            if ("object" == typeof o || void 0 === o ? t[e].slick = new r(t[e], o) : i = t[e].slick[o].apply(t[e].slick, s), void 0 !== i) return i;
        return t
    }
}),
function (e, i) {
    if ("function" == typeof define && define.amd) define(["module", "exports"], i);
    else if ("undefined" != typeof exports) i(module, exports);
    else {
        var t = {
            exports: {}
        };
        i(t, t.exports), e.surfacing = t.exports
    }
}(this, function (e, i) {
    "use strict";
    var t, o;
    ...
    function a(e, i, t) {
        null != e.addEventListener ? e.addEventListener(i, t, !1) : null != e.attachEvent ? e.attachEvent("on" + i, t) : e[i] = t
    }

    function d(e, i, t) {
        null != e.removeEventListener ? e.removeEventListener(i, t, !1) : null != e.detachEvent ? e.detachEvent("on" + i, t) : delete e[i]
    }
    var c = window.WeakMap || window.MozWeakMap || (n(p, [{
        key: "get",
        value: function (e) {
        ...
        value: function (e, i) {
            for (var t = 0; t < this.keys.length; t++)
                if (this.keys[t] === e) return this.values[t] = i, this;
            return this.keys.push(e), this.values.push(i), this
        }
    }]), p);

    function p() {
        s(this, p), this.keys = [], this.values = []
    }
    var u = window.MutationObserver || window.WebkitMutationObserver || window.MozMutationObserver || (n(h, [{
        key: "observe",
        value: function () {}
    }]), o = t = h, t.notSupported = !0, o);

    function h() {
        s(this, h), "undefined" != typeof console && null !== console && (console.warn("MutationObserver is not supported by your browser."), console.warn("surfacing.js cannot detect dom mutations, please call .sync() after loading new content."))
    }
    var f = window.getComputedStyle || function (t) {
            var o = /(\-([a-z]){1})/g;
            return {
                getPropertyValue: function (e) {
                    "float" === e && (e = "styleFloat"), o.test(e) && e.replace(o, function (e, i) {
                        return i.toUpperCase()
                    });
                    var i = t.currentStyle;
                    return (null != i ? i[e] : void 0) || null
                }
            }
        },
        v = (n(y, [{
            key: "init",
            value: function () {
                this.element = window.document.documentElement, l(document.readyState, ["interactive", "complete"]) ? this.start() : a(document, "DOMContentLoaded", this.start), this.finished = []
            }
        }, {
            key: "start",
            value: function () {
                ...
                this.disabled() || (a(this.config.scrollContainer || window, "scroll", this.scrollHandler), a(window, "resize", this.scrollHandler), this.interval = setInterval(this.scrollCallback, 50)), this.config.live && new u(function (e) {
                    for (var i = 0; i < e.length; i++)
                        for (var t = e[i], o = 0; o < t.addedNodes.length; o++) {
            ...
            value: function (e) {
                if (null == e && (e = this.element), 1 === e.nodeType)
                    for (var i = (e = e.parentNode || e).querySelectorAll("." + this.config.boxClass), t = 0; t < i.length; t++) {
                        var o = i[t];
                        l(o, this.all) || (this.boxes.push(o), this.all.push(o), this.stopped || this.disabled() ? this.resetStyle() : this.applyStyle(o, !0), this.scrolled = !0)
                    }
            }
        }, {
            key: "show",
            value: function (e) {
                return this.applyStyle(e), e.className = e.className + " " + this.config.animateClass, null != this.config.callback && this.config.callback(e),
                    ...
                    }(e, this.surfacingEvent), a(e, "animationend", this.resetAnimation), a(e, "oanimationend", this.resetAnimation), a(e, "webkitAnimationEnd", this.resetAnimation), a(e, "MSAnimationEnd", this.resetAnimation), e
            }
        }, {
            key: "applyStyle",
            value: function (e, i) {
                var t = this,
                    o = e.getAttribute("data-surfacing-duration"),
                    s = e.getAttribute("data-surfacing-delay"),
                    n = e.getAttribute("data-surfacing-iteration");
                return this.animate(function () {
                    return t.customStyle(e, i, o, s, n)
                })
            }
        }, {
            key: "resetStyle",
            ...
            key: "customStyle",
            value: function (e, i, t, o, s) {
                return i && this.cacheAnimationName(e), e.style.visibility = i ? "hidden" : "visible", t && this.vendorSet(e.style, {
                    animationDuration: t
            ...
            value: function (e, i) {
                for (var t in i)
                    if (i.hasOwnProperty(t)) {
                        var o = i[t];
                        e["" + t] = o;
                        for (var s = 0; s < this.vendors.length; s++) e["" + this.vendors[s] + t.charAt(0).toUpperCase() + t.substr(1)] = o
                    }
            }
        }, {
            key: "vendorCSS",
            value: function (e, i) {
                for (var t = f(e), o = t.getPropertyCSSValue(i), s = 0; s < this.vendors.length; s++) {
                    var n = this.vendors[s];
                    o = o || t.getPropertyCSSValue("-" + n + "-" + i)
                }
                return o
            }
        }, {
            ...
            value: function (i) {
                var t = void 0;
                try {
                    t = this.vendorCSS(i, "animation-name").cssText
                } catch (e) {
                    t = f(i).getPropertyValue("animation-name")
                }
                return "none" === t ? "" : t
            }
        }, {
            ...
            key: "isVisible",
            value: function (e) {
                var i = e.getAttribute("data-surfacing-offset") || this.config.offset,
                    t = this.config.scrollContainer && this.config.scrollContainer.scrollTop || window.pageYOffset,
                    o = t + Math.min(this.element.clientHeight, "innerHeight" in window ? window.innerHeight : document.documentElement.clientHeight) - i,
                    s = this.offsetTop(e),
                    n = s + e.clientHeight;
                return s <= o && t <= n
            }
    ...
    function y() {
        ...
        s(this, y), this.defaults = {
            ...
            return e()
        }, this.vendors = ["moz", "webkit"], this.start = this.start.bind(this), this.resetAnimation = this.resetAnimation.bind(this), this.scrollHandler = this.scrollHandler.bind(this), this.scrollCallback = this.scrollCallback.bind(this), this.scrolled = !0, this.config = function (e, i) {
            for (var t in i)
                if (null == e[t]) {
                    var o = i[t];
                    e[t] = o
                } return e
        }(e, this.defaults), null != e.scrollContainer && (this.config.scrollContainer = document.querySelector(e.scrollContainer)), this.animationNameCache = new c, this.surfacingEvent = function (e, i, t, o) {
            var s = !(arguments.length <= 1 || void 0 === i) && i,
                n = !(arguments.length <= 2 || void 0 === t) && t,
                r = arguments.length <= 3 || void 0 === o ? null : o,
                l = void 0;
            return null != document.createEvent ? (l = document.createEvent("CustomEvent")).initCustomEvent(e, s, n, r) : null != document.createEventObject ? (l = document.createEventObject()).eventType = e : l.eventName = e, l
